...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { menuId, page: pageId } = Astro2.params;
  ...
  return renderTemplate`${renderComponent($$result, "MenuLayout", $$MenuLayout, { "menu": menu, "accountSettings": accountSettings }, { "default": async ($$result2) => renderTemplate`${menu && renderTemplate`${renderComponent($$result2, "MenuCache", MenuCache, { "client:load": true, "type": "preview", "identifier": menuId, "menu": menu, "accountSettings": accountSettings ?? void 0, "client:component-hydration": "load", "client:component-path": "@/components/MenuCache", "client:component-export": "MenuCache" })}`}${renderComponent($$result2, "Menu", $$Menu, { "menu": menu, "currentPage": currentPage, "accountSettings": accountSettings, "error": error, "menuId": menuId })} ` })}`;
}, "/Users/jcmujica/Code/jc/waitless/waitless-menu/src/pages/preview/[menuId]/[page]/index.astro", void 0);

const $$file = "/Users/jcmujica/Code/jc/waitless/waitless-menu/src/pages/preview/[menuId]/[page]/index.astro";
const $$url = "/preview/[menuId]/[page]";
